...
from simpleappnews.models import Post\
    , Category


class Command(BaseCommand):
    help = 'Удалит все новости из какой-либо категории, но только при подтверждении действия в консоли при выполнении команды'
